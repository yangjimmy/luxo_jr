...
#include "realsense2_camera_msgs/msg/detail/metadata__rosidl_typesupport_fastrtps_c.h"
...
using _Metadata__ros_msg_type = realsense2_camera_msgs__msg__Metadata;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
bool cdr_serialize_realsense2_camera_msgs__msg__Metadata(
  const realsense2_camera_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
bool cdr_deserialize_realsense2_camera_msgs__msg__Metadata(
  eprosima::fastcdr::Cdr & cdr,
  realsense2_camera_msgs__msg__Metadata * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
size_t max_serialized_size_realsense2_camera_msgs__msg__Metadata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = realsense2_camera_msgs__msg__Metadata;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
bool cdr_serialize_key_realsense2_camera_msgs__msg__Metadata(
  const realsense2_camera_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
size_t get_serialized_size_key_realsense2_camera_msgs__msg__Metadata(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Metadata__ros_msg_type * ros_message = static_cast<const _Metadata__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense2_camera_msgs
size_t max_serialized_size_key_realsense2_camera_msgs__msg__Metadata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const realsense2_camera_msgs__msg__Metadata * ros_message = static_cast<const realsense2_camera_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_realsense2_camera_msgs__msg__Metadata(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  realsense2_camera_msgs__msg__Metadata * ros_message = static_cast<realsense2_camera_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_realsense2_camera_msgs__msg__Metadata(cdr, ros_message);
}

static uint32_t _Metadata__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_realsense2_camera_msgs__msg__Metadata(
...
static size_t _Metadata__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_realsense2_camera_msgs__msg__Metadata(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, msg, Metadata)() {

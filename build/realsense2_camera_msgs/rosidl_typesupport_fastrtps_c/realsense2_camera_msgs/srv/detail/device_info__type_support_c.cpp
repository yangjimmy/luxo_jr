  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const realsense2_camera_msgs__srv__DeviceInfo_Request * ros_message = static_cast<const realsense2_camera_msgs__srv__DeviceInfo_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_realsense2_camera_msgs__srv__DeviceInfo_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  realsense2_camera_msgs__srv__DeviceInfo_Request * ros_message = static_cast<realsense2_camera_msgs__srv__DeviceInfo_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_realsense2_camera_msgs__srv__DeviceInfo_Request(cdr, ros_message);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const realsense2_camera_msgs__srv__DeviceInfo_Response * ros_message = static_cast<const realsense2_camera_msgs__srv__DeviceInfo_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_realsense2_camera_msgs__srv__DeviceInfo_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  realsense2_camera_msgs__srv__DeviceInfo_Response * ros_message = static_cast<realsense2_camera_msgs__srv__DeviceInfo_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_realsense2_camera_msgs__srv__DeviceInfo_Response(cdr, ros_message);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_realsense2_camera_msgs__srv__DeviceInfo_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_realsense2_camera_msgs__srv__DeviceInfo_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  realsense2_camera_msgs__srv__DeviceInfo_Event * ros_message)
{
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_realsense2_camera_msgs__srv__DeviceInfo_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_realsense2_camera_msgs__srv__DeviceInfo_Response(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = realsense2_camera_msgs__srv__DeviceInfo_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_realsense2_camera_msgs__srv__DeviceInfo_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_realsense2_camera_msgs__srv__DeviceInfo_Response(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_realsense2_camera_msgs__srv__DeviceInfo_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_realsense2_camera_msgs__srv__DeviceInfo_Response(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_realsense2_camera_msgs__srv__DeviceInfo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_realsense2_camera_msgs__srv__DeviceInfo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const realsense2_camera_msgs__srv__DeviceInfo_Event * ros_message = static_cast<const realsense2_camera_msgs__srv__DeviceInfo_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_realsense2_camera_msgs__srv__DeviceInfo_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  realsense2_camera_msgs__srv__DeviceInfo_Event * ros_message = static_cast<realsense2_camera_msgs__srv__DeviceInfo_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_realsense2_camera_msgs__srv__DeviceInfo_Event(cdr, ros_message);
}

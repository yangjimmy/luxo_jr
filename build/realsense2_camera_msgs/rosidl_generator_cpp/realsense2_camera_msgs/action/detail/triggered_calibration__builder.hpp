...
class Init_TriggeredCalibration_SendGoal_Event_response
{
public:
  explicit Init_TriggeredCalibration_SendGoal_Event_response(::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event response(::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event::_response_type arg)
  {
...
private:
  ::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event msg_;
};

class Init_TriggeredCalibration_SendGoal_Event_request
{
public:
  explicit Init_TriggeredCalibration_SendGoal_Event_request(::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_TriggeredCalibration_SendGoal_Event_response request(::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TriggeredCalibration_SendGoal_Event_response(msg_);
  }
...
class Init_TriggeredCalibration_SendGoal_Event_info
{
public:
  Init_TriggeredCalibration_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TriggeredCalibration_SendGoal_Event_request info(::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TriggeredCalibration_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::realsense2_camera_msgs::action::TriggeredCalibration_SendGoal_Event>()
{
  return realsense2_camera_msgs::action::builder::Init_TriggeredCalibration_SendGoal_Event_info();
}
...
class Init_TriggeredCalibration_GetResult_Event_response
{
public:
  explicit Init_TriggeredCalibration_GetResult_Event_response(::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event response(::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event msg_;
};

class Init_TriggeredCalibration_GetResult_Event_request
{
public:
  explicit Init_TriggeredCalibration_GetResult_Event_request(::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_TriggeredCalibration_GetResult_Event_response request(::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_TriggeredCalibration_GetResult_Event_response(msg_);
  }
...
class Init_TriggeredCalibration_GetResult_Event_info
{
public:
  Init_TriggeredCalibration_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TriggeredCalibration_GetResult_Event_request info(::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_TriggeredCalibration_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::realsense2_camera_msgs::action::TriggeredCalibration_GetResult_Event>()
{
  return realsense2_camera_msgs::action::builder::Init_TriggeredCalibration_GetResult_Event_info();
}

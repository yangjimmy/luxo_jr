...
static const _CalibConfigWrite_Event_type_support_symbol_names_t _CalibConfigWrite_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense2_camera_msgs, srv, CalibConfigWrite_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, srv, CalibConfigWrite_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, realsense2_camera_msgs, srv, CalibConfigWrite_Event)() {
  return &::realsense2_camera_msgs::srv::rosidl_typesupport_c::CalibConfigWrite_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t CalibConfigWrite_service_type_support_handle = {
  ...
  &CalibConfigWrite_Request_message_type_support_handle,
  &CalibConfigWrite_Response_message_type_support_handle,
  &CalibConfigWrite_Event_message_type_support_handle,

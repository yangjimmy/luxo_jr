...
## Have to use the code below before running this node:
...
class ReadWriteNode(Node):
    ...
    def __init__(self):
        ...
        self.setup_dynamixel(1)
        self.setup_dynamixel(2)
        self.setup_dynamixel(3)
        self.setup_dynamixel(4)
        self.setup_dynamixel(5)
        self.setup_dynamixel(6)
